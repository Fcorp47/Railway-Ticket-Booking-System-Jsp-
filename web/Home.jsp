				...
				<div class="row">
					<div class="col-md-7 col-md-push-5">
						<div class="booking-cta">
                                                    <h1 style="color:white">AP | RAILWAYS</h1>
							...
							<form>
								...
								<div class="form-group">
									<span class="form-label">FROM</span>
                                                                        <input class="form-control" name="txtfrom" id="fromtxt" onkeyup="searchInfo()" type="text" placeholder="FROM">                                                                       
                                                                        <div id="mylocation"> </div>
                                                                        
                                                                </div>  
                                                                <div class="form-group">
                                                                            <span class="form-label">TO </span>
                                                                            <input class="form-control" name="txtto" onkeyup="searchstat()" id="totxt" type="text" placeholder="TO">
								...
								<div class="form-btn">
                                                                    <button type="submit" name="btn" value="searchtrain" class="submit-btn">Search Trains</button>
								</div><br><br>
