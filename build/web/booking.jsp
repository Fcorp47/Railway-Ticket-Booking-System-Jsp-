...
<html>
    ...
    <body>
         ...
         <%
            ...
            //(url parameter that I passed from seatlayout page)converting the string into int array after string splitting 
            //SEAT BOOK ARRAY
            String seats_str = request.getParameter("seat_book");
           
            String[] res =  seats_str.split("[,]", 0);
             ...
             //converting the list into STACK that i retrieved from tbltrain 
        
                String seat_stack = traindetails;  
            String temp="";
            for(int i=0; i<seat_stack.length();i++)         //to remove the brackets inside the list string
            {
                ...
                //now removing the matching seats from stack
                          ...
                          //  Listtrain.get(10);
                           int pricecoach = Integer.parseInt(strtrainarr[10]);
                            ...
                            {
                               price = Float.parseFloat(request.getParameter("length"))*pricecoach;
                               conv_fee = 30;
    ...
    <center>
                     <h1><% out.print(request.getParameter("trainno")); %></h1> 
  ...
  <div class="container">
      ...
      <input type="text" name="txtpname" placeholder="Passenger Name" required="" id="<%="txtname"+x %>" class="txtChk" required>&nbsp;&nbsp;
